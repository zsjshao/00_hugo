...
![nginx_25](http://images.zsjshao.cn/images/linux_basic/31-nginx/nginx_25.png)
...
![nginx_26](http://images.zsjshao.cn/images/linux_basic/31-nginx/nginx_26.png)

##### 5.2.2.2：临时重定向：

域名临时重定向，告诉浏览器域名不是固定重定向到当前目标域名，后期可能随时会更改，因此浏览器不会缓存当前域名的解析记录，而浏览器会缓存永久重定向的DNS解析记录，这也是临时重定向与永久重定向最大的本质区别。

![nginx_27](http://images.zsjshao.cn/images/linux_basic/31-nginx/nginx_27.png)
...
![nginx_28](http://images.zsjshao.cn/images/linux_basic/31-nginx/nginx_28.png)
...
![nginx_29](http://images.zsjshao.cn/images/linux_basic/31-nginx/nginx_29.png)
...
![nginx_30](http://images.zsjshao.cn/images/linux_basic/31-nginx/nginx_30.png)
...
![nginx_31](http://images.zsjshao.cn/images/linux_basic/31-nginx/nginx_31.png)
...
![nginx_32](http://images.zsjshao.cn/images/linux_basic/31-nginx/nginx_32.png)
...
##### 6.3.2.5：访问验证php测试页面：
![nginx_33](http://images.zsjshao.cn/images/linux_basic/31-nginx/nginx_33.png)
...
![nginx_34](http://images.zsjshao.cn/images/linux_basic/31-nginx/nginx_34.png)
